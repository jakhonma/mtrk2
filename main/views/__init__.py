from main.views.information import InformationCreateAPIView, InformationUpdateAPIView, InformationDestroyAPIView, InformationListAPIView, InformationRetrieveAPIView
